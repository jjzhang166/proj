...
/*
LoginAssistServer::LoginAssistServer() : Server(P_Port_LoginAssist)
{
...
LoginAssistOperS::LoginAssistOperS(LoginAssistS& login_assist) : JsonEchoBase(LuaThrdData::AsRef<Lua_l&>(), login_assist), login_assist_(login_assist)
{
