...
#define HOOK(oldfun,newfun)		\
	DetourTransactionBegin();		\
	DetourUpdateThread(GetCurrentThread());		\
	DetourAttach(&(PVOID&)oldfun,newfun);		\
	DetourTransactionCommit();

#define HOOKEX(oldfun,newfun,jmpfun)		\
	DetourTransactionBegin();					\
	DetourUpdateThread(GetCurrentThread());		\
	DetourAttachEx(&(PVOID&)oldfun,newfun,&(PDETOUR_TRAMPOLINE&)jmpfun,0, 0);		\
	DetourTransactionCommit();