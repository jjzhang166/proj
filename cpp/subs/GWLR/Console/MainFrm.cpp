...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWnd)
	...
	ON_WM_SETFOCUS()
	ON_WM_CLOSE()
	ON_COMMAND(ID_MENU_REMOVE_BIND, &CMainFrame::OnMenuRemoveBind)
...
void CMainFrame::OnMenuRemoveBind()
{
	dlg_remove_bind_.DoModal();
}
...
DlgLogin& 
#endif
	CMainFrame::GetDlgLogin()
{
#ifdef _MULTI_LOGIN_
	return dlg_multi_login_;
#else
	return dlg_login_;
#endif;
}
