...
BOOL DlgAutoDial::OnInitDialog()
{
	...
	combo_select_mode_.InsertString(stSingletonCfg::stAutoDialInfo::kDM_AsAc, _T("°´Ë¢ºÅ²¦ºÅ"));
	combo_select_mode_.InsertString(stSingletonCfg::stAutoDialInfo::kDM_AsTime, _T("°´Ê±¼ä²¦ºÅ"));
	const auto& single_cfg = stSingletonCfg::GetMe();
