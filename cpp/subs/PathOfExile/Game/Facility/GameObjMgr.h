...
public:
	...
	GameObjBasePtrT FindObjInCircleByType(enGameObjType obj_type, const stCD_VecInt& center, int radius) const;
	...
	void ResetAll();
	void EraseRemObj(const GameObjBase& obj);
...
private:
	...
	GameObjBase* CreateGameObj(enGameObjType type) const;
...
public:
	...
	GameObjMgr(enGameObjType type, const Args... types) : filter_type_(type, types...){}
	template<typename... Args>
