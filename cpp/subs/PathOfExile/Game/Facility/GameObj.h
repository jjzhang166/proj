...
public:
	...
	void ResetPos();
	inline enGameObjType GetObjType() const { return obj_type_; }
	inline pt_dword GetGameId() const { /*assert(id_ > 0);*/ return id_; }
	virtual int GetAreaId() const;
	//这个不能删
...
public:
	...
	//virtual GChecksumType Checksum() const;
...
protected:
	...
	virtual bool MustCanTargetable() const;
...
private:
	...
	enCD_TouchTargetSmallFlag open_flag_;
};