...
static wxLuaArgType s_wxluatypeArray_wxLua_wxListCtrl_HasCheckboxes[] = { &wxluatype_wxListCtrl, NULL };
static int LUACALL wxLua_wxListCtrl_HasCheckboxes(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxListCtrl_HasCheckboxes[1] = { { wxLua_wxListCtrl_HasCheckboxes, WXLUAMETHOD_METHOD, 1, 1, s_wxluatypeArray_wxLua_wxListCtrl_HasCheckboxes } };

static wxLuaArgType s_wxluatypeArray_wxLua_wxListCtrl_EnableCheckboxes[] = { &wxluatype_wxListCtrl, &wxluatype_TBOOLEAN, NULL };
static int LUACALL wxLua_wxListCtrl_EnableCheckboxes(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxListCtrl_EnableCheckboxes[1] = { { wxLua_wxListCtrl_EnableCheckboxes, WXLUAMETHOD_METHOD, 1, 2, s_wxluatypeArray_wxLua_wxListCtrl_EnableCheckboxes } };

static wxLuaArgType s_wxluatypeArray_wxLua_wxListCtrl_IsItemChecked[] = { &wxluatype_wxListCtrl, &wxluatype_TNUMBER, NULL };
static int LUACALL wxLua_wxListCtrl_IsItemChecked(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxListCtrl_IsItemChecked[1] = { { wxLua_wxListCtrl_IsItemChecked, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxListCtrl_IsItemChecked } };

static wxLuaArgType s_wxluatypeArray_wxLua_wxListCtrl_CheckItem[] = { &wxluatype_wxListCtrl, &wxluatype_TNUMBER, &wxluatype_TBOOLEAN, NULL };
static int LUACALL wxLua_wxListCtrl_CheckItem(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxListCtrl_CheckItem[1] = { { wxLua_wxListCtrl_CheckItem, WXLUAMETHOD_METHOD, 3, 3, s_wxluatypeArray_wxLua_wxListCtrl_CheckItem } };
...
static int LUACALL wxLua_wxListCtrl_HasCheckboxes(lua_State *L)
{
	...
	wxListCtrl * self = (wxListCtrl *)wxluaT_getuserdatatype(L, 1, wxluatype_wxListCtrl);
	// call GetItemCount
	auto returns = (self->HasCheckboxes());
	// push the result number
	lua_pushboolean(L, returns);
	return 1;
}
...
static int LUACALL wxLua_wxListCtrl_EnableCheckboxes(lua_State *L)
{
	int argCount = lua_gettop(L);
	// const bool add = true
	const bool enable = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : true);
	// get this
	wxListCtrl * self = (wxListCtrl *)wxluaT_getuserdatatype(L, 1, wxluatype_wxListCtrl);
	auto returns = self->EnableCheckboxes(enable);
	lua_pushboolean(L, returns);
	return 1;
}
...
{
	// const bool add = true
	const long item = (long)wxlua_getnumbertype(L, 2);
	// get this
	wxListCtrl * self = (wxListCtrl *)wxluaT_getuserdatatype(L, 1, wxluatype_wxListCtrl);
	auto returns = self->IsItemChecked(item);
	lua_pushboolean(L, returns);
	return 1;
}
...
static int LUACALL wxLua_wxListCtrl_CheckItem(lua_State *L)
{
	...
	// get this
	wxListCtrl * self = (wxListCtrl *)wxluaT_getuserdatatype(L, 1, wxluatype_wxListCtrl);
	self->CheckItem(item, wxlua_getbooleantype(L, 3));
	return 0;
}
...
wxLuaBindMethod wxListCtrl_methods[] = {
	...
	{ "HasCheckboxes", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxListCtrl_HasCheckboxes, 1, NULL },
	{ "EnableCheckboxes", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxListCtrl_EnableCheckboxes, 1, NULL },
	{ "IsItemChecked", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxListCtrl_IsItemChecked, 1, NULL },
	{ "CheckItem", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxListCtrl_CheckItem, 1, NULL },
