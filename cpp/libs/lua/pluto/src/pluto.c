...
LUALIB_API void pluto_persist(lua_State *L, lua_Chunkwriter writer, void *ud)
{
	PersistInfo pi;
...
LUALIB_API void pluto_unpersist(lua_State *L, lua_Chunkreader reader, void *ud)
{
...
LUALIB_API int luaopen_pluto(lua_State *L) {
	luaI_openlib(L, "pluto", pluto_reg, 0);
	return 1;
}
