...
//by zhp 2016/11/17 1:16
#ifdef _WIN32_WINNT
static_assert(_WIN32_WINNT == BOOST_WINAPI_VERSION_WIN7, "must be win7");
#else
#define _WIN32_WINNT BOOST_WINAPI_VERSION_WIN7
#endif
...
//by zhp
static_assert(BOOST_USE_WINAPI_VERSION == _WIN32_WINNT, "BOOST_USE_WINAPI_VERSION must equal");
