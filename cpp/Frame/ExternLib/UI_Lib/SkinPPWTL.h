...
typedef struct _ResourceInfo
{
	...
	char	szResImageName[_MAX_FNAME];//[IN]
	BOOL	bHorzSplit;//[IN]
	int		nLength;//[IN]
	int		nCount; //[IN]
	int		nIndex; //[IN]
...
SKINPPWTL_API BOOL skinppLoadSkinFromRes(HINSTANCE hInstance, const char* szResourceName,
										 const char* szResourceType, char* szSkinFileName);
